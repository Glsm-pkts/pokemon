...
const pokemonDiv = document.createElement("div")//!htmldeki pokemon classını silip bir div elementi olusturduk
pokemonDiv.classList.add("pokemon")//!şimdide oluşturduğumuz div class verdik
